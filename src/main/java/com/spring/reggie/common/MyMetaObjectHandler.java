...
public class MyMetaObjectHandler implements MetaObjectHandler {
    ...
    public void insertFill(MetaObject metaObject){//在插入时执行
        ...
        //此处需要获取request=>session=>Attribute中的id属性，暂时获得不了

        metaObject.setValue("createUser", com.spring.reggie.common.BaseContext.getCurrentUserId());
        metaObject.setValue("updateUser", com.spring.reggie.common.BaseContext.getCurrentUserId());
    }
    /**
     * 更新操作时自动填充
     * @param metaObject
